...
if(isset($registry->request->get['lang'])){
    $_SESSION['lang'] = $registry->request->get['lang'];
    $registry->config->lang = $registry->request->get['lang'];
    $registry->config->new_lang = true;
}
elseif(isset($registry->session->data['lang'])){
    $registry->config->lang = $registry->session->data['lang'];
}
